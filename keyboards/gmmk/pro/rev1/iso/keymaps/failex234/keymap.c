...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [1] = LAYOUT(
        ...
        _______, KC_KP_1, KC_KP_2, KC_KP_3, KC_KP_4, KC_KP_5, KC_KP_6, KC_KP_7, KC_KP_8, KC_KP_9, KC_KP_0, _______, _______, QK_BOOT,          KC_KP_MINUS,
...
//Base taken from chofstede keymap for gmmk/pro/rev1/iso
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    if (host_keyboard_led_state().caps_lock) {
        rgb_matrix_set_color(LED_TAB, 255, 255, 255);
        rgb_matrix_set_color(LED_CAPS, 255, 255, 255);
        rgb_matrix_set_color(LED_SHIFT_LEFT, 255, 255, 255);
    }

    //Alle LEDs am Rand werden rot, wenn die FN-Taste gedrückt wird (wenn wir zu Layer 1 wechseln)
